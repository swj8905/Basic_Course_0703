...
code = req.urlopen(f"https://images.search.yahoo.com/search/images;_ylt=AwrS_AqE8uhgQU4AzTJXNyoA;_ylu=Y29sbwNncTEEcG9zAzEEdnRpZAMEc2VjA3BpdnM-?p={encoded}&fr2=piv-web&fr=yfp-t")
soup = BeautifulSoup(code, "html.parser")
img = soup.select("a > img")
for i in img:
    img_url = i.attrs["data-src"] # .attrs : 요소의 속성
